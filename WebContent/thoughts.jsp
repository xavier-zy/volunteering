...
<%@page import="com.bbs.bean.TUser,com.bbs.bean.Thoughts,com.bbs.bean.TUserInfo"%>
...
<section id="inner-page">
  <div class="container">
    <div class="center">
      <h2 style="margin-left:-120px;">感想录之</h2>   
      <p style="font-size:25px;"><%=ThoughtsDao.getThoughtsById(id).getThoughtsTitle()%></p><br>
      <span style="float:right;">作者:<%=TUserDao.getTUserById((ThoughtsDao.getThoughtsById(id).getUserId()).toString()).getNickname()%></span>
      <span style="float:right;">发表时间:<%=ThoughtsDao.getThoughtsById(id).getPublishTime()%>&nbsp;&nbsp;</span>
    </div>
	<h3>
	<%=ThoughtsDao.getThoughtsById(id).getThoughtsContent()%>
 </h3>
 <br/>
  <br/>
   <br/>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        ...
        <p>如果你有什么想法，请投稿给我们 123456@qq.com<br>
          </p>
