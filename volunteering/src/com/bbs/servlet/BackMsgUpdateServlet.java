...
@WebServlet("/api/updateBackMsg")
public class BackMsgUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int m_backMsgID = Integer.parseInt(request.getParameter("id"));
		...
		backMsg.setBackMsgID(m_backMsgID);
		
		int isSuccess = BackMsgDao.updateBackMsg( backMsg);
		if (isSuccess > 0)
		{
