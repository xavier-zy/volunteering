...
/**
 * Servlet implementation class MyActivityInsertServlet
 */
@WebServlet("/api/MyActivityInsertServlet")
public class MyActivityInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyActivityInsertServlet() {
        super();
...
//		result.setActivityStatus("1");
		int rowNumber=MyActivityDao.addMyActivity(result);
//		MyActivity result2 = MyActivityDao.getMyActivityById(2);
		if (0==rowNumber) {
