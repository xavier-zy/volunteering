...
/**
 * Servlet implementation class TUserInfoUpdateServlet
 */
@WebServlet("/api/TUserInfoUpdateServlet")
public class TUserInfoUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TUserInfoUpdateServlet() {
        super();
...
//		tuserinfo.setId(Integer.parseInt(request.getParameter("id")));
...
//		tuserinfo.setUserId(4);
//		tuserinfo.setUsername("zhangsan");
//		tuserinfo.setTime("20150704173752");
//		tuserinfo.setId(8);
		int rowNumber=TUserInfoDao.updateTUserInfo(tuserinfo);
