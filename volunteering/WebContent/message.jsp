...
<%@page import="com.bbs.bean.TUser,com.bbs.bean.Message"%>
<%@page import="com.bbs.dao.MessageDao"%>
<%
	String path = request.getContextPath();
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
			+ path + "/";
	TUser tuser = (TUser) session.getAttribute("tuser");
	ArrayList<Message> messages=MessageDao.getMessageAll();
%>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-left"
					...
					<ul class="nav navbar-nav">
						...
						%>
						<li class="active"><a href="message.jsp">信息管理</a></li>
		...
		<div class="container">
			<div class="center">
				...
				<ul class="nav nav-tabs">
					<li role="presentation" class="active"><a href="message.jsp">查看留言</a></li>
			...
			<div>
				<div>
					<table class="table table-hover">
						...
						%>
						<tr>
							<td><%=!messages.get(i).getUserName().equals("")?messages.get(i).getUserName():"游客" %></td>
